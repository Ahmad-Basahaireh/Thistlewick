...
/**
 * {@code User} — an Aggregate Root representing a Thistlewick user.
 *
 * <h2>Design notes</h2>
 * <ul>
...
public class User {
    ...
    /**
     * Rehydrates a user from persistence. Used by repositories only.
     */
    ...
    /** Changes the user's email. Guaranteed valid because Email is a VO. */
